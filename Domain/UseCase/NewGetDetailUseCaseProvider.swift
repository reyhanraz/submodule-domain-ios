//
//  NewGetDetailUseCaseProvider.swift
//  Domain
//
...
public struct NewGetDetailUseCaseProvider<R, CloudService: ServiceType, CacheService: ServiceType, Provider: Cache, ServiceResponse: NewResponseType>: UseCase
    where
